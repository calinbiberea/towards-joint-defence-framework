...
def get_Mahalanobis_score(model, test_loader, num_classes, outf, out_flag, net_type, sample_mean, precision, layer_index, magnitude):
    ...
    for data, target in test_loader:
        ...
        if net_type == 'densenet':
            ...
            # This is a bonus I wrote for single channel images
            # Should do nothing I think, should be fine the way it is, right?

            # Otherwise consider applying the same weird gradient scaling (hopefully not)
            pass
